...
class MobileNetV2(nn.Module):
    def __init__(self, num_attributes=2, input_size=224, width_mult=0.01):
        ...
        self.stem = fc_block(output_channel, 2)
        for i in range(num_attributes):
            setattr(self, 'classifier' + str(i).zfill(2), nn.Sequential(fc_block(2, 2), nn.Linear(2, 2)))
...
def init_pretrained_weights(model, path=os.path.expanduser('/home/chenxin/disk1/github/face-attribute-prediction/checkpoints/model_best.pth.tar')):
    """
