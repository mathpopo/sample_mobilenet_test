...
parser.add_argument('--resume', default='/home/chenxin/disk1/github/face-attribute-prediction/checkpoints/model_best.pth.tar', type=str, metavar='PATH',
...
def validate(val_loader, model, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (input, target) in enumerate(val_loader):
            ...
            for j in range(len(output)):
                loss.append(criterion(output[j], target[:, j]))
                prec1.append(accuracy1(output[j], target[:, j], topk=(1,)))
